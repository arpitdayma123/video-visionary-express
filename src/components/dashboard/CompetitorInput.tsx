...
const CompetitorInput = ({
  ...
  return (
    <section className="animate-fade-in">
      ...
      <p className="text-muted-foreground mb-2">Add instagram usernames of competitors or accounts with similar content (max 15)</p>
      
      <Alert variant="warning" className="mb-4">
        <AlertTriangle className="h-4 w-4" />
        <AlertDescription>
          Please enter correct Instagram usernames only. Incorrect usernames may result in errors during processing.
        </AlertDescription>
      </Alert>

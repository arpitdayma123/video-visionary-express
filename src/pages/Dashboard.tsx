      ...
      <div className="section-container py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-12">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex">
                          <button 
                            ...
                            className={`p-1.5 rounded-full mr-1 transition-colors ${selectedVoice?.id === file.id ? 'bg-primary text-primary-foreground' : 'hover:bg-secondary-foreground/10'}`} 
          ...
          <section className="animate-fade-in">
            ...
            <p className="text-muted-foreground mb-6">Select your niches of interest</p>
          ...
          <section className="animate-fade-in">
            ...
            <p className="text-muted-foreground mb-6">Add up to 15 competitor usernames</p>
            ...
            <ul className="space-y-2">
              {competitors.map((competitor, index) => (
                <li key={index} className="flex justify-between items-center">
                  ...
                  <button onClick={() => handleRemoveCompetitor(index)} className="text-red-500 hover:underline">Remove</button>
                </li>
              ))}
            </ul>
          </section>
          ...
          <div className="mt-8 flex justify-end">
            <Button
              type="submit"
              disabled={isProcessing || !isFormComplete || userCredits < 1}

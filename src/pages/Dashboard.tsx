...
const Dashboard = () => {
  ...
  // Voice recording functions with higher quality settings
          ...
          if (user) {
            try {
              ...
              toast({
                ...
                description: `Voice recording saved (${Math.round(duration)} seconds) and set as target voice.`
              });
            } catch (error) {
